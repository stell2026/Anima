...
function write_gui_state!(a::Anima, r; audit = nothing, cf_co = nothing)
    ...
    state = Dict(
        ...
        "self" => Dict(
            ...
            "actions_pending" => r.actions.pending,
            "last_action" => r.actions.last_goal,
            "last_action_status" => r.actions.last_status,
        ...
        "why" => Dict(
            "intent" => r.intent_label,
            "action_goal" => r.actions.last_goal,
            "action_origin" => r.actions.last_origin,
            "expected_valence" => r.actions.expected_valence,
            "authored_goal" => r.authorship.goal,
            "authored_stake" => r.authorship.stake,
            "mal_dominant" => ct.mal_dominant,
            "mal_regime" => ct.mal_regime,
            "mal_determinant" => ct.mal_determinant,
            "mal_runner_up" => ct.mal_runner_up,
            "last_outcome_goal" => r.actions.outcome_goal,
            "last_outcome_status" => r.actions.outcome_status,
            "last_outcome_valence" => r.actions.actual_valence,
            "last_outcome_ownership" => r.actions.outcome_ownership,
            "values" => Dict(
                "autonomy" => a.values.autonomy, "care" => a.values.care,
                "fairness" => a.values.fairness, "integrity" => a.values.integrity,
                "growth" => a.values.growth,
            ),
        ),
    )
